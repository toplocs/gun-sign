...
Gun.valid = require('gun/src/valid');
Gun.state = require('gun/src/state');
Gun.on = require('gun/src/onto');
Gun.dup = require('gun/src/dup');
Gun.ask = require('gun/src/ask');
...
Gun.log.once("welcome", "LOCAL: Hello wonderful person! :) Thanks for using GUN, please ask for help on http://chat.gun.eco if anything takes you longer than 5min to figure out!");
}());